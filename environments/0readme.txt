...
In order to resolve this issue, I provide two environments in different yml files.  The "before2019" and "after2019" files have setups for old (pyFAI 0.15) and new (pyFAI 0.17) dpp files, respectively.