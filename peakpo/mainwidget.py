...
class DesignerMainWindow(QtWidgets.QMainWindow, Ui_MplMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.version = 7.11
        self.setWindowTitle("PeakPo ver. {0: 5.2f}".format(self.version))
        self.about()
        # get objects
        ...
        self.ucfitlist = []  # list for unitcell fitting
        self.DiffImg = None
        self.poni_filename = None
        ###############################
        # set visualization parameters
        self.waterfallgap = self.mpldoubleSpinBox_WaterfallGaps.value()
        self.objColor = 'white'
        self.cakeOn = False
        ##########################
        # set physical parameters
        # self.wavelength = self.mpldoubleSpinBox_SetWavelength.value()
        # self.pressure = self.mpldoubleSpinBox_Pressure.value()
        # self.temperature = self.mpldoubleSpinBox_Temperature.value()
        # Todo: check names of the box first and then change
        self.readSettings()
...
#        self.chi_path       = '' #reduendant, but easier to code
        ...
        self.mplcheckBox_Intensity.clicked.connect(self.set_jcpdsint)
        ...
        self.mplpushButton_ApplyCakeView.clicked.connect(self.apply_CakeView)
...
#        QtCore.QObject.connect(self.mplactionClose, \
#            QtCore.SIGNAL('triggered()'), QtGui.qApp, QtCore.SLOT("quit()"))
        ...
        self.ntb_ResetY.clicked.connect(self.set_resetY)
        #
        ...
        self.ntb_Bgsub.clicked.connect(self.set_background)
        #
        ...
        # no more stuff can be added
    """
    # begin for the wheel activity stops
    ...
    def eventFilter(self, obj, event):
        ...
        if event.type() == QtCore.QEvent.Wheel and isinstance(
            ...
            return super(DesignerMainWindow, self).eventFilter(obj, event)
    # end for wheel activity stops
    """

    def apply_CakeView(self):
        """
        Cake function
        Wraper for update_graph.  I cannot directly call update_graph()
        """
        self.update_graph()
    ...
    def _list_ucfit(self):
        ...
        for row in range(n_rows):
            ...
            self.mpltableWidget_UnitCell_pushButton_color = QtWidgets.QPushButton('change')
            ...
            # column 5 - a
            self.mpltableWidget_UnitCell_doubleSpinBox_a = QtWidgets.QDoubleSpinBox()
            ...
            self.mpltableWidget_UnitCell_doubleSpinBox_a.setStyle(SpinBoxFixStyle())
            self.mpltableWidget_UnitCell.setCellWidget(
            ...
            if (self.ucfitlist[row].symmetry == 'cubic'):
                ...
                self.mpltableWidget_UnitCell_doubleSpinBox_c = QtWidgets.QDoubleSpinBox()
            ...
            if not (self.ucfitlist[row].symmetry == 'triclinic'):
                ...
                self.mpltableWidget_UnitCell_doubleSpinBox_alpha = QtWidgets.QDoubleSpinBox()
            ...
            if (self.ucfitlist[row].symmetry == 'cubic') or \
                ...
                self.mpltableWidget_UnitCell_doubleSpinBox_beta = QtWidgets.QDoubleSpinBox()
            ...
            if not (self.ucfitlist[row].symmetry == 'triclinic'):
                ...
                self.mpltableWidget_UnitCell_doubleSpinBox_gamma = QtWidgets.QDoubleSpinBox()
...
#               Make sure you overwrite the file again after opening.')
    ...
    def about(self):
        QtWidgets.QMessageBox.about(
            self, 'About',
            '<font size="10" color = red>PeakPo ver. \
            {0:5.2f}</font><br><br>'.format(self.version) +
            '<font size="4" color = blue>A Visual Diffraction Analysis Tool \
            </font><br><br>' +
    ...
    def _list_wfpatterns(self):
        ...
        for row in range(n_rows):
            ...
            # column 3 - color setup
            self.mpltableWidget_wfPatterns_pushButton_color = QtWidgets.QPushButton('change')
            ...
            # column 4 - wavelength
            self.mpltableWidget_wfPatterns_doubleSpinBox_wavelength = QtWidgets.QDoubleSpinBox()
            ...
            self.mpltableWidget_wfPatterns_doubleSpinBox_wavelength.\
                setKeyboardTracking(False)
            self.mpltableWidget_wfPatterns_doubleSpinBox_wavelength.setFocusPolicy(
                QtCore.Qt.ClickFocus)
...
#        self._list_jcpds()
    ...
    def _list_jcpds(self):
        ...
        for row in range(n_rows):
            ...
            # column 3 - color setup
            self.mpltableWidget_JCPDS_pushButton_color = QtWidgets.QPushButton('change')
            ...
            # column 4 - V0 tweak
            self.mpltableWidget_JCPDS_doubleSpinBox_V0twk = QtWidgets.QDoubleSpinBox()
            ...
            self.mpltableWidget_JCPDS_doubleSpinBox_K0twk.setFocusPolicy(
                QtCore.Qt.ClickFocus)
            # column 6 - K0p tweak
            self.mpltableWidget_JCPDS_doubleSpinBox_K0ptwk = QtWidgets.QDoubleSpinBox()
            ...
            self.mpltableWidget_JCPDS_doubleSpinBox_alpha0twk = QtWidgets.QDoubleSpinBox()
            ...
            if (self.jlist[row].symmetry == 'cubic') or \
                ...
                self.mpltableWidget_JCPDS_doubleSpinBox_b_atwk = QtWidgets.QDoubleSpinBox()
            ...
            if (self.jlist[row].symmetry == 'cubic'):
                ...
                self.mpltableWidget_JCPDS_doubleSpinBox_c_atwk = QtWidgets.QDoubleSpinBox()
                ...
                self.mpltableWidget_JCPDS_doubleSpinBox_c_atwk.setFocusPolicy(
                    QtCore.Qt.ClickFocus)
            # column 10 - int tweak
            self.mpltableWidget_JCPDS_doubleSpinBox_inttwk = QtWidgets.QDoubleSpinBox()
            ...
            self.mpltableWidget_JCPDS_doubleSpinBox_inttwk.setFocusPolicy(
                QtCore.Qt.ClickFocus)
            self.mpltableWidget_JCPDS_doubleSpinBox_alpha0twk.setKeyboardTracking(False)
            self.mpltableWidget_JCPDS_doubleSpinBox_inttwk.setKeyboardTracking(False)
            self.mpltableWidget_JCPDS_doubleSpinBox_K0ptwk.setKeyboardTracking(False)
            self.mpltableWidget_JCPDS_doubleSpinBox_K0twk.setKeyboardTracking(False)
            self.mpltableWidget_JCPDS_doubleSpinBox_V0twk.setKeyboardTracking(False)
...
#        self._list_jcpds()
    ...
    def set_waterfallgap(self, value):
        self.waterfallgap = value
        self.update_graph()
        ...
        for pattern in self.waterfallpatterns:
            if pattern.display:
                ...
                self.mpl.canvas.ax.text(0.01, 0.97 - i * 0.03 + j * 0.03,
                                        ...
                                        color=pattern.color)
                if self.ntb_Bgsub.isChecked():
                    ygap = self.waterfallgap * self.Pattern.y_bgsub.max() * \
                        float(j)
                    ...
                    ygap = self.waterfallgap * self.Pattern.y_raw.max() * \
                        float(j)
                    if self.mplcheckBox_IntNorm.isChecked():
